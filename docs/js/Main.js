...
var $author$project$Messages$tooltip_switches = 'Total number of stock switch sets that you own. A set of switches sufficient to fill a normal-sized board. Duplicate sets are counted if they were purchased separately or are used/intended to be used on separate boards.';
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A3($author$project$View$inputField, 'Switch sets (total)', $author$project$Messages$tooltip_switches, $author$project$Model$setSwitchSets),
