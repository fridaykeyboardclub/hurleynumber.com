...
var $author$project$Main$init = function (_v0) {
	var model = {
		input: {accessories: $elm$core$Maybe$Nothing, accessoryGbs: $elm$core$Maybe$Nothing, artisanGbs: $elm$core$Maybe$Nothing, artisans: $elm$core$Maybe$Nothing, cableGbs: $elm$core$Maybe$Nothing, cables: $elm$core$Maybe$Nothing, deskpadGbs: $elm$core$Maybe$Nothing, deskpads: $elm$core$Maybe$Nothing, keyboardGbs: $elm$core$Maybe$Nothing, keyboards: $elm$core$Maybe$Nothing, keycapGbs: $elm$core$Maybe$Nothing, keycapSets: $elm$core$Maybe$Nothing, modifiedSwitchSets: $elm$core$Maybe$Nothing, switchGbs: $elm$core$Maybe$Nothing, unmodifiedSwitchSets: $elm$core$Maybe$Nothing}
	};
...
var $author$project$Main$update = F2(
	function (event, model) {
		var f = event.a;
		var updated_input = _Utils_update(
			model,
			{
				input: f(model.input)
			});
		return _Utils_Tuple2(updated_input, $elm$core$Platform$Cmd$none);
	});
...
var $author$project$Model$orZero = function (maybe) {
	return A2($elm$core$Maybe$withDefault, 0, maybe);
};
var $author$project$Model$calculateA = function (input) {
	if (_Utils_eq(input.artisans, $elm$core$Maybe$Nothing) && (_Utils_eq(input.artisanGbs, $elm$core$Maybe$Nothing) && (_Utils_eq(input.deskpads, $elm$core$Maybe$Nothing) && (_Utils_eq(input.deskpadGbs, $elm$core$Maybe$Nothing) && (_Utils_eq(input.cables, $elm$core$Maybe$Nothing) && (_Utils_eq(input.cableGbs, $elm$core$Maybe$Nothing) && (_Utils_eq(input.accessories, $elm$core$Maybe$Nothing) && _Utils_eq(input.accessoryGbs, $elm$core$Maybe$Nothing)))))))) {
		return $elm$core$Maybe$Nothing;
	} else {
		var g_a = (($author$project$Model$orZero(input.artisanGbs) + $author$project$Model$orZero(input.deskpadGbs)) + $author$project$Model$orZero(input.cableGbs)) + $author$project$Model$orZero(input.accessoryGbs);
		var a = (($author$project$Model$orZero(input.artisans) + $author$project$Model$orZero(input.deskpads)) + $author$project$Model$orZero(input.cables)) + $author$project$Model$orZero(input.accessories);
		return $elm$core$Maybe$Just((a + g_a) / 4);
	}
};
var $author$project$Model$calculateC = function (input) {
	if (_Utils_eq(input.keycapSets, $elm$core$Maybe$Nothing) && _Utils_eq(input.keycapGbs, $elm$core$Maybe$Nothing)) {
		return $elm$core$Maybe$Nothing;
	} else {
		var g_c = $author$project$Model$orZero(input.keycapGbs);
		var c = $author$project$Model$orZero(input.keycapSets);
		return $elm$core$Maybe$Just(c + g_c);
	}
};
var $author$project$Model$calculateK = function (input) {
	if (_Utils_eq(input.keyboards, $elm$core$Maybe$Nothing) && _Utils_eq(input.keyboardGbs, $elm$core$Maybe$Nothing)) {
		return $elm$core$Maybe$Nothing;
	} else {
		var k_i = $author$project$Model$orZero(input.keyboards);
		var g_k = $author$project$Model$orZero(input.keyboardGbs);
		return $elm$core$Maybe$Just(k_i + g_k);
	}
};
var $author$project$Model$calculateS = function (input) {
	if (_Utils_eq(input.unmodifiedSwitchSets, $elm$core$Maybe$Nothing) && (_Utils_eq(input.modifiedSwitchSets, $elm$core$Maybe$Nothing) && _Utils_eq(input.switchGbs, $elm$core$Maybe$Nothing))) {
		return $elm$core$Maybe$Nothing;
	} else {
		var s_u = $author$project$Model$orZero(input.unmodifiedSwitchSets);
		var s_c = $author$project$Model$orZero(input.modifiedSwitchSets);
		var g_s = $author$project$Model$orZero(input.switchGbs);
...
var $author$project$Model$calculate = function (input) {
	var switches = A2(
		$elm$core$Maybe$withDefault,
		0,
	...
	var keycaps = A2(
		$elm$core$Maybe$withDefault,
		0,
		$author$project$Model$calculateC(input));
	var keyboards = A2(
		$elm$core$Maybe$withDefault,
		0,
	...
	return A2($myrho$elm_round$Round$round, 1, calculated);
};
...
var $author$project$View$formulaNumber = F3(
	function (name, altText, maybeNumber) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('formula-head-part'),
								$elm$html$Html$Attributes$class('formula-part')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('img/mykehead.png'),
										$elm$html$Html$Attributes$id('mykehead')
									]),
								_List_Nil),
								$elm$html$Html$text('=')
							])),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('formula-fraction-part'),
								$elm$html$Html$Attributes$class('formula-part')
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('formula-fraction-top')
									]),
								_List_fromArray(
									[
										A3(
										$author$project$View$formulaNumber,
										'K',
										'Keyboards',
										$author$project$Model$calculateK(model.input)),
										$elm$html$Html$text(' + '),
										A3(
										$author$project$View$formulaNumber,
										'S',
										'Switches',
										$author$project$Model$calculateS(model.input)),
										$elm$html$Html$text(' + '),
										A3(
										$author$project$View$formulaNumber,
										'C',
										'Keycaps',
										$author$project$Model$calculateC(model.input)),
										$elm$html$Html$text(' + '),
										A3(
										$author$project$View$formulaNumber,
										'A',
										'Accessories / 4',
										$author$project$Model$calculateA(model.input))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('formula-fraction-bottom'),
										$elm$html$Html$Attributes$class('formula-part')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('formula-result-part'),
								$elm$html$Html$Attributes$class('formula-part')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								'= ' + $author$project$Model$calculate(model.input))
							]))
					]))
			]));
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $author$project$Model$UpdateEvent = function (a) {
	return {$: 'UpdateEvent', a: a};
};
var $author$project$View$doInput = F2(
	function (updater, str) {
		return $author$project$Model$UpdateEvent(
			updater(
...
var $author$project$View$inputField = F3(
	function (name, tooltip, updateField) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('inputrow')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$View$doInput(updateField))
								]),
							_List_Nil)
						]))
				]));
	});
var $author$project$Model$setAccessories = F2(
	function (a, model) {
...
var $author$project$Model$setUnmodifiedSwitchSets = F2(
	function (a, model) {
		return _Utils_update(
			model,
...
var $author$project$View$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$View$formula(model),
				$author$project$View$inputFields
			]));
};
