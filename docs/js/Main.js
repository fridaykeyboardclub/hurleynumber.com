...
var $author$project$Model$calculateA = function (input) {
	if (_Utils_eq(input.aq, $elm$core$Maybe$Nothing) && (_Utils_eq(input.ap, $elm$core$Maybe$Nothing) && (_Utils_eq(input.aw, $elm$core$Maybe$Nothing) && (_Utils_eq(input.av, $elm$core$Maybe$Nothing) && (_Utils_eq(input.at, $elm$core$Maybe$Nothing) && (_Utils_eq(input.as, $elm$core$Maybe$Nothing) && (_Utils_eq(input.am, $elm$core$Maybe$Nothing) && _Utils_eq(input.an, $elm$core$Maybe$Nothing)))))))) {
		return $elm$core$Maybe$Nothing;
	} else {
		var g_a = (($author$project$Model$orZero(input.ap) + $author$project$Model$orZero(input.av)) + $author$project$Model$orZero(input.as)) + $author$project$Model$orZero(input.an);
		var a = (($author$project$Model$orZero(input.aq) + $author$project$Model$orZero(input.aw)) + $author$project$Model$orZero(input.at)) + $author$project$Model$orZero(input.am);
...
var $author$project$Model$calculateK = function (input) {
	if (_Utils_eq(input.aE, $elm$core$Maybe$Nothing) && _Utils_eq(input.aD, $elm$core$Maybe$Nothing)) {
		return $elm$core$Maybe$Nothing;
	} else {
...
var $author$project$Model$calculateS = function (input) {
	if (_Utils_eq(input.aQ, $elm$core$Maybe$Nothing) && (_Utils_eq(input.aH, $elm$core$Maybe$Nothing) && _Utils_eq(input.aO, $elm$core$Maybe$Nothing))) {
		return $elm$core$Maybe$Nothing;
	} else {
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										'K',
										'Keyboards',
										$author$project$Model$calculateK(model.E)),
										$elm$html$Html$text(' + '),
										A3(
										$author$project$View$formulaNumber,
										'S',
										'Switches',
										$author$project$Model$calculateS(model.E)),
										$elm$html$Html$text(' + '),
										A3(
										$author$project$View$formulaNumber,
										'C',
										'Keycaps',
										$author$project$Model$calculateC(model.E)),
										$elm$html$Html$text(' + '),
										A3(
										$author$project$View$formulaNumber,
										'A',
										'Accessories / 4',
										$author$project$Model$calculateA(model.E))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'= ' + $author$project$Model$calculate(model.E))
							]))
					]))
			]));
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $author$project$Model$UpdateEvent = $elm$core$Basics$identity;
